...
#define HC12EEP_START   0x800
#define HC12EEP_LEN     0x200

/*
**  Prescaler = eXtal / 28571.
*/

void HC12EepA_Init(HC12EepA_ConfigType const * const ConfigPtr)
{
    HC12EEP_REG8(EEDIVH)   = HIBYTE(ConfigPtr->EeDiv);
    HC12EEP_REG8(EEDIVL)   = LOBYTE(ConfigPtr->EeDiv);
