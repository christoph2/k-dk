...
/*
   All works fine!
 */
0x01..0x 1f      Task number, response GBS_CREATE
/*
   The GBS_CREATE returns the task
   number of the new created task in
   com_res.
 */
0x20..0x 7f      User defined errors
/*
...
BBHANDLE    Bitbus_OpenSlave(const char * AppName, const char * BitbusDevice, uint8 TaskId, uint8 FunctionId,
