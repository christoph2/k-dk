 ...
 *
 */
#if !defined(__MC9S12I32_CONFIG_H)
#define __MC9S12I32_CONFIG_H
...
#define S12_FEATURE_D2DI        STD_ON
...
#define S12_FEATURE_S           STD_OFF
#define S12_FEATURE_S12GPIM     STD_OFF
#define S12_FEATURE_SCI0        STD_OFF
...
#define BASE_ADDR_M             KDK_MAKE_BASE_ADDR(0x0005)
#define BASE_ADDR_ID            KDK_MAKE_BASE_ADDR(0x001A)
#define BASE_ADDR_S12SINT       KDK_MAKE_BASE_ADDR(0x001F)
#define BASE_ADDR_DBG           KDK_MAKE_BASE_ADDR(0x0020)
#define BASE_ADDR_S12XDBG       KDK_MAKE_BASE_ADDR(0x0020)
#define BASE_ADDR_S12SMMC       KDK_MAKE_BASE_ADDR(0x0030)
#define BASE_ADDR_CRG           KDK_MAKE_BASE_ADDR(0x0034)
#define BASE_ADDR_RTI           KDK_MAKE_BASE_ADDR(0x003C)
#define BASE_ADDR_COP           KDK_MAKE_BASE_ADDR(0x003E)
#define BASE_ADDR_D2DI          KDK_MAKE_BASE_ADDR(0x00D8)
#define BASE_ADDR_SPI0          KDK_MAKE_BASE_ADDR(0x00E8)


#define S12_CAN_NUM_CONTROLLERS                 ((uint8)0)


#define S12_SCI_NUM_INTERFACES                  ((uint8)0)
...
#define S12MEBI_PORT_C                           ((Kdk_PortType)0x1)  /* 0x4 */
#define S12PIM_PORT_M                           ((Kdk_PortType)0x2)  /* 0x5 */
...
#define S12MEBI_CHANNEL_C_0                      ((Kdk_ChannelType)((1 * 8) + 0))
#define S12MEBI_CHANNEL_C_1                      ((Kdk_ChannelType)((1 * 8) + 1))
#define S12MEBI_CHANNEL_C_2                      ((Kdk_ChannelType)((1 * 8) + 2))
#define S12MEBI_CHANNEL_C_3                      ((Kdk_ChannelType)((1 * 8) + 3))
#define S12MEBI_CHANNEL_C_4                      ((Kdk_ChannelType)((1 * 8) + 4))
#define S12MEBI_CHANNEL_C_5                      ((Kdk_ChannelType)((1 * 8) + 5))
#define S12MEBI_CHANNEL_C_6                      ((Kdk_ChannelType)((1 * 8) + 6))
#define S12MEBI_CHANNEL_C_7                      ((Kdk_ChannelType)((1 * 8) + 7))
