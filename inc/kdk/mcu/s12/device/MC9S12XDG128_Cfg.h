 ...
 *
 */
#if !defined(__MC9S12XDG128_CONFIG_H)
#define __MC9S12XDG128_CONFIG_H
...
#define S12_FEATURE_MSCAN4      STD_ON
...
#define BASE_ADDR_MSCAN4        KDK_MAKE_BASE_ADDR(0x0280)
...
#define S12_SPI_NUM_INTERFACES                  ((uint8)2)
