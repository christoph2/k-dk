 ...
 *
 */
#if !defined(__MC9S12H256_CONFIG_H)
#define __MC9S12H256_CONFIG_H
...
#define S12_FEATURE_EEPROM      STD_ON
...
#define BASE_ADDR_PWM           KDK_MAKE_BASE_ADDR(0x00E0)
#define BASE_ADDR_FLASH         KDK_MAKE_BASE_ADDR(0x0100)
#define BASE_ADDR_EEPROM        KDK_MAKE_BASE_ADDR(0x0110)
#define BASE_ADDR_LCD           KDK_MAKE_BASE_ADDR(0x0120)
#define BASE_ADDR_CAN_CTL       KDK_MAKE_BASE_ADDR(0x0180)
#define BASE_ADDR_CAN_RX        KDK_MAKE_BASE_ADDR(0x01A0)
#define BASE_ADDR_CAN_TX        KDK_MAKE_BASE_ADDR(0x01B0)
...
#define BASE_ADDR_H             KDK_MAKE_BASE_ADDR(0x0220)
#define BASE_ADDR_J             KDK_MAKE_BASE_ADDR(0x0228)
...
** Ports.
*/
#define S12PIM_PORT_T                           ((Kdk_PortType)0x0)  /* 0x200 */
#define S12PIM_PORT_S                           ((Kdk_PortType)0x1)  /* 0x208 */
#define S12PIM_PORT_M                           ((Kdk_PortType)0x2)  /* 0x210 */
#define S12PIM_PORT_P                           ((Kdk_PortType)0x3)  /* 0x218 */
#define S12PIM_PORT_H                           ((Kdk_PortType)0x4)  /* 0x220 */
#define S12PIM_PORT_J                           ((Kdk_PortType)0x5)  /* 0x228 */
#define S12PIM2_PORT_L                           ((Kdk_PortType)0x6)  /* 0x230 */
#define S12PIM_PORT_U                           ((Kdk_PortType)0x7)  /* 0x238 */
#define S12PIM_PORT_V                           ((Kdk_PortType)0x8)  /* 0x240 */
#define S12PIM_PORT_W                           ((Kdk_PortType)0x9)  /* 0x248 */
...
#define S12PIM2_CHANNEL_L_0                      ((Kdk_ChannelType)((6 * 8) + 0))
#define S12PIM2_CHANNEL_L_1                      ((Kdk_ChannelType)((6 * 8) + 1))
#define S12PIM2_CHANNEL_L_2                      ((Kdk_ChannelType)((6 * 8) + 2))
#define S12PIM2_CHANNEL_L_3                      ((Kdk_ChannelType)((6 * 8) + 3))
#define S12PIM2_CHANNEL_L_4                      ((Kdk_ChannelType)((6 * 8) + 4))
#define S12PIM2_CHANNEL_L_5                      ((Kdk_ChannelType)((6 * 8) + 5))
#define S12PIM2_CHANNEL_L_6                      ((Kdk_ChannelType)((6 * 8) + 6))
#define S12PIM2_CHANNEL_L_7                      ((Kdk_ChannelType)((6 * 8) + 7))
...
#define S12PIM_CHANNEL_W_0                      ((Kdk_ChannelType)((9 * 8) + 0))
#define S12PIM_CHANNEL_W_1                      ((Kdk_ChannelType)((9 * 8) + 1))
#define S12PIM_CHANNEL_W_2                      ((Kdk_ChannelType)((9 * 8) + 2))
#define S12PIM_CHANNEL_W_3                      ((Kdk_ChannelType)((9 * 8) + 3))
#define S12PIM_CHANNEL_W_4                      ((Kdk_ChannelType)((9 * 8) + 4))
#define S12PIM_CHANNEL_W_5                      ((Kdk_ChannelType)((9 * 8) + 5))
#define S12PIM_CHANNEL_W_6                      ((Kdk_ChannelType)((9 * 8) + 6))
#define S12PIM_CHANNEL_W_7                      ((Kdk_ChannelType)((9 * 8) + 7))
