 ...
 *
 */
#if !defined(__MC9S12GN16_CONFIG_H)
#define __MC9S12GN16_CONFIG_H
...
#define S12_FEATURE_ACMP        STD_ON
...
#define S12_FEATURE_S12GPIM     STD_ON
...
#define BASE_ADDR_S12GPIM       KDK_MAKE_BASE_ADDR(0x024F)
#define BASE_ADDR_M             KDK_MAKE_BASE_ADDR(0x0250)
#define BASE_ADDR_P             KDK_MAKE_BASE_ADDR(0x0258)
#define BASE_ADDR_ACMP          KDK_MAKE_BASE_ADDR(0x0260)
...
** Ports.
*/
#define S12MEBI_PORT_E                           ((Kdk_PortType)0x0)  /* 0x8 */
#define S12PIM_PORT_T                           ((Kdk_PortType)0x1)  /* 0x240 */
#define S12PIM_PORT_S                           ((Kdk_PortType)0x2)  /* 0x248 */
#define S12PIM_PORT_M                           ((Kdk_PortType)0x3)  /* 0x250 */
#define S12PIM_PORT_P                           ((Kdk_PortType)0x4)  /* 0x258 */
#define S12PIM_PORT_J                           ((Kdk_PortType)0x5)  /* 0x268 */


/*
** Symbolic Names for Port-Pins.
*/
#define S12MEBI_CHANNEL_E_0                      ((Kdk_ChannelType)((0 * 8) + 0))
#define S12MEBI_CHANNEL_E_1                      ((Kdk_ChannelType)((0 * 8) + 1))
#define S12MEBI_CHANNEL_E_2                      ((Kdk_ChannelType)((0 * 8) + 2))
#define S12MEBI_CHANNEL_E_3                      ((Kdk_ChannelType)((0 * 8) + 3))
#define S12MEBI_CHANNEL_E_4                      ((Kdk_ChannelType)((0 * 8) + 4))
#define S12MEBI_CHANNEL_E_5                      ((Kdk_ChannelType)((0 * 8) + 5))
#define S12MEBI_CHANNEL_E_6                      ((Kdk_ChannelType)((0 * 8) + 6))
#define S12MEBI_CHANNEL_E_7                      ((Kdk_ChannelType)((0 * 8) + 7))

#define S12PIM_CHANNEL_T_0                      ((Kdk_ChannelType)((1 * 8) + 0))
#define S12PIM_CHANNEL_T_1                      ((Kdk_ChannelType)((1 * 8) + 1))
#define S12PIM_CHANNEL_T_2                      ((Kdk_ChannelType)((1 * 8) + 2))
#define S12PIM_CHANNEL_T_3                      ((Kdk_ChannelType)((1 * 8) + 3))
#define S12PIM_CHANNEL_T_4                      ((Kdk_ChannelType)((1 * 8) + 4))
#define S12PIM_CHANNEL_T_5                      ((Kdk_ChannelType)((1 * 8) + 5))
#define S12PIM_CHANNEL_T_6                      ((Kdk_ChannelType)((1 * 8) + 6))
#define S12PIM_CHANNEL_T_7                      ((Kdk_ChannelType)((1 * 8) + 7))

#define S12PIM_CHANNEL_S_0                      ((Kdk_ChannelType)((2 * 8) + 0))
#define S12PIM_CHANNEL_S_1                      ((Kdk_ChannelType)((2 * 8) + 1))
#define S12PIM_CHANNEL_S_2                      ((Kdk_ChannelType)((2 * 8) + 2))
#define S12PIM_CHANNEL_S_3                      ((Kdk_ChannelType)((2 * 8) + 3))
#define S12PIM_CHANNEL_S_4                      ((Kdk_ChannelType)((2 * 8) + 4))
#define S12PIM_CHANNEL_S_5                      ((Kdk_ChannelType)((2 * 8) + 5))
#define S12PIM_CHANNEL_S_6                      ((Kdk_ChannelType)((2 * 8) + 6))
#define S12PIM_CHANNEL_S_7                      ((Kdk_ChannelType)((2 * 8) + 7))

#define S12PIM_CHANNEL_M_0                      ((Kdk_ChannelType)((3 * 8) + 0))
#define S12PIM_CHANNEL_M_1                      ((Kdk_ChannelType)((3 * 8) + 1))
#define S12PIM_CHANNEL_M_2                      ((Kdk_ChannelType)((3 * 8) + 2))
#define S12PIM_CHANNEL_M_3                      ((Kdk_ChannelType)((3 * 8) + 3))
#define S12PIM_CHANNEL_M_4                      ((Kdk_ChannelType)((3 * 8) + 4))
#define S12PIM_CHANNEL_M_5                      ((Kdk_ChannelType)((3 * 8) + 5))
#define S12PIM_CHANNEL_M_6                      ((Kdk_ChannelType)((3 * 8) + 6))
#define S12PIM_CHANNEL_M_7                      ((Kdk_ChannelType)((3 * 8) + 7))
