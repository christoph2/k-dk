 ...
 *
 */
#if !defined(__MC9S12DB128_CONFIG_H)
#define __MC9S12DB128_CONFIG_H
...
#define S12_FEATURE_ATD0        STD_ON
#define S12_FEATURE_ATD1        STD_ON
#define S12_FEATURE_B           STD_OFF
#define S12_FEATURE_BDLC        STD_OFF
#define S12_FEATURE_BF          STD_ON
...
#define BASE_ADDR_ATD0          KDK_MAKE_BASE_ADDR(0x0082)
...
#define BASE_ADDR_ATD1          KDK_MAKE_BASE_ADDR(0x0122)
...
#define BASE_ADDR_CAN_CTL       KDK_MAKE_BASE_ADDR(0x0280)
#define BASE_ADDR_CAN_RX        KDK_MAKE_BASE_ADDR(0x02A0)
#define BASE_ADDR_CAN_TX        KDK_MAKE_BASE_ADDR(0x02B0)
#define BASE_ADDR_BF_CTL        KDK_MAKE_BASE_ADDR(0x0300)
#define BASE_ADDR_BF_TX         KDK_MAKE_BASE_ADDR(0x0320)
#define BASE_ADDR_BF_RX_DATA     KDK_MAKE_BASE_ADDR(0x0330)
#define BASE_ADDR_BF_RX_FIFO     KDK_MAKE_BASE_ADDR(0x0340)
#define BASE_ADDR_BF_BUFFER     KDK_MAKE_BASE_ADDR(0x0350)
...
#define S12PIM_PORT_H                           ((Kdk_PortType)0x4)  /* 0x260 */
