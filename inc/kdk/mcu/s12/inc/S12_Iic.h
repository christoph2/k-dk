...
void    S12Iic_Start(S12Iic_ConfigType const * const Config);
void    S12Iic_Restart(S12Iic_ConfigType const * const Config);
void    S12Iic_Stop(S12Iic_ConfigType const * const Config);
boolean S12Iic_Write(S12Iic_ConfigType const * const Config, uint8 b);
void    S12Iic_Read(S12Iic_ConfigType const * const Config, /*@out@*/ uint8 * b, boolean ack);
