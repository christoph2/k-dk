 ...
 *
 */
#if !defined(__MC9S12I128_CONFIG_H)
#define __MC9S12I128_CONFIG_H
...
#define BASE_ADDR_C             KDK_MAKE_BASE_ADDR(0x000D)
#define BASE_ADDR_D             KDK_MAKE_BASE_ADDR(0x000D)
#define BASE_ADDR_PARTID        KDK_MAKE_BASE_ADDR(0x001A)
#define BASE_ADDR_SINT          KDK_MAKE_BASE_ADDR(0x001F)
...
#define BASE_ADDR_D2D           KDK_MAKE_BASE_ADDR(0x00D8)
...
#define S12MEBI_PORT_C                           ((Kdk_PortType)0x2)  /* 0xd */
#define S12MEBI_PORT_D                           ((Kdk_PortType)0x3)  /* 0xd */
