 ...
 *
 */
#if !defined(__MC9S12DP512_CONFIG_H)
#define __MC9S12DP512_CONFIG_H
...
#define S12_FEATURE_BDLC        STD_ON
...
#define S12_FEATURE_XGATE       STD_OFF
        ...
        Address is None MSCAN2
        Address is None MSCAN3
...
#define BASE_ADDR_BDLC          KDK_MAKE_BASE_ADDR(0x00E8)
...
#define BASE_ADDR_CAN_CTL       KDK_MAKE_BASE_ADDR(0x0200)
#define BASE_ADDR_CAN_RX        KDK_MAKE_BASE_ADDR(0x0220)
#define BASE_ADDR_CAN_TX        KDK_MAKE_BASE_ADDR(0x0230)
