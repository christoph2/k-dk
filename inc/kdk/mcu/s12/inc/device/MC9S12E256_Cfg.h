 ...
 *
 */
#if !defined(__MC9S12E256_CONFIG_H)
#define __MC9S12E256_CONFIG_H
...
#define S12_FEATURE_DAC0        STD_ON
#define S12_FEATURE_DAC1        STD_ON
...
#define S12_FEATURE_TIM2        STD_ON
...
#define BASE_ADDR_DAC0          KDK_MAKE_BASE_ADDR(0x00F0)
#define BASE_ADDR_DAC1          KDK_MAKE_BASE_ADDR(0x00F4)
#define BASE_ADDR_FLASH         KDK_MAKE_BASE_ADDR(0x0100)
#define BASE_ADDR_TIM1          KDK_MAKE_BASE_ADDR(0x0140)
#define BASE_ADDR_TIM2          KDK_MAKE_BASE_ADDR(0x0180)
#define BASE_ADDR_PWM           KDK_MAKE_BASE_ADDR(0x01E0)
#define BASE_ADDR_PMF           KDK_MAKE_BASE_ADDR(0x0200)
...
#define BASE_ADDR_U             KDK_MAKE_BASE_ADDR(0x0268)
...
#define S12PIM_PORT_U                           ((Kdk_PortType)0x5)  /* 0x268 */
