 ...
 *
 */
#if !defined(__MC9S12G128_CONFIG_H)
#define __MC9S12G128_CONFIG_H
...
#define BASE_ADDR_SCI2          KDK_MAKE_BASE_ADDR(0x00E8)
...
#define S12_SCI_NUM_INTERFACES                  ((uint8)3)
...
#define S12PIM_PORT_T                           ((Kdk_PortType)0x5)  /* 0x240 */
#define S12PIM_PORT_S                           ((Kdk_PortType)0x6)  /* 0x248 */
#define S12PIM_PORT_M                           ((Kdk_PortType)0x7)  /* 0x250 */
#define S12PIM_PORT_P                           ((Kdk_PortType)0x8)  /* 0x258 */
...
#define S12PIM_CHANNEL_T_0                      ((Kdk_ChannelType)((5 * 8) + 0))
#define S12PIM_CHANNEL_T_1                      ((Kdk_ChannelType)((5 * 8) + 1))
#define S12PIM_CHANNEL_T_2                      ((Kdk_ChannelType)((5 * 8) + 2))
#define S12PIM_CHANNEL_T_3                      ((Kdk_ChannelType)((5 * 8) + 3))
#define S12PIM_CHANNEL_T_4                      ((Kdk_ChannelType)((5 * 8) + 4))
#define S12PIM_CHANNEL_T_5                      ((Kdk_ChannelType)((5 * 8) + 5))
#define S12PIM_CHANNEL_T_6                      ((Kdk_ChannelType)((5 * 8) + 6))
#define S12PIM_CHANNEL_T_7                      ((Kdk_ChannelType)((5 * 8) + 7))
...
#define S12PIM_CHANNEL_M_0                      ((Kdk_ChannelType)((7 * 8) + 0))
#define S12PIM_CHANNEL_M_1                      ((Kdk_ChannelType)((7 * 8) + 1))
#define S12PIM_CHANNEL_M_2                      ((Kdk_ChannelType)((7 * 8) + 2))
#define S12PIM_CHANNEL_M_3                      ((Kdk_ChannelType)((7 * 8) + 3))
#define S12PIM_CHANNEL_M_4                      ((Kdk_ChannelType)((7 * 8) + 4))
#define S12PIM_CHANNEL_M_5                      ((Kdk_ChannelType)((7 * 8) + 5))
#define S12PIM_CHANNEL_M_6                      ((Kdk_ChannelType)((7 * 8) + 6))
#define S12PIM_CHANNEL_M_7                      ((Kdk_ChannelType)((7 * 8) + 7))

#define S12PIM_CHANNEL_P_0                      ((Kdk_ChannelType)((8 * 8) + 0))
#define S12PIM_CHANNEL_P_1                      ((Kdk_ChannelType)((8 * 8) + 1))
#define S12PIM_CHANNEL_P_2                      ((Kdk_ChannelType)((8 * 8) + 2))
#define S12PIM_CHANNEL_P_3                      ((Kdk_ChannelType)((8 * 8) + 3))
#define S12PIM_CHANNEL_P_4                      ((Kdk_ChannelType)((8 * 8) + 4))
#define S12PIM_CHANNEL_P_5                      ((Kdk_ChannelType)((8 * 8) + 5))
#define S12PIM_CHANNEL_P_6                      ((Kdk_ChannelType)((8 * 8) + 6))
#define S12PIM_CHANNEL_P_7                      ((Kdk_ChannelType)((8 * 8) + 7))
