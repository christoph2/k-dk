 ...
 *
 */
#if !defined(__MC9S12HY32_CONFIG_H)
#define __MC9S12HY32_CONFIG_H
...
#define S12_FEATURE_CPMU        STD_ON
...
#define S12_FEATURE_INT         STD_OFF
...
#define S12_FEATURE_M           STD_OFF
#define S12_FEATURE_MC          STD_ON
#define S12_FEATURE_MMC         STD_OFF
...
#define S12_FEATURE_PMMC        STD_ON
...
#define S12_FEATURE_SINT        STD_ON
...
#define S12_FEATURE_VREG        STD_OFF
...
#define BASE_ADDR_PMMC          KDK_MAKE_BASE_ADDR(0x000B)
...
#define BASE_ADDR_CPMU          KDK_MAKE_BASE_ADDR(0x0034)
...
#define BASE_ADDR_SINT          KDK_MAKE_BASE_ADDR(0x0120)
...
#define BASE_ADDR_AD            KDK_MAKE_BASE_ADDR(0x0271)
...
#define S12PIM_PORT_P                           ((Kdk_PortType)0x4)  /* 0x258 */
#define S12PIM_PORT_H                           ((Kdk_PortType)0x5)  /* 0x260 */
#define S12PIM2_PORT_R                           ((Kdk_PortType)0x6)  /* 0x280 */
#define S12PIM_PORT_U                           ((Kdk_PortType)0x7)  /* 0x290 */
#define S12PIM_PORT_V                           ((Kdk_PortType)0x8)  /* 0x298 */
...
#define S12PIM_CHANNEL_P_0                      ((Kdk_ChannelType)((4 * 8) + 0))
#define S12PIM_CHANNEL_P_1                      ((Kdk_ChannelType)((4 * 8) + 1))
#define S12PIM_CHANNEL_P_2                      ((Kdk_ChannelType)((4 * 8) + 2))
#define S12PIM_CHANNEL_P_3                      ((Kdk_ChannelType)((4 * 8) + 3))
#define S12PIM_CHANNEL_P_4                      ((Kdk_ChannelType)((4 * 8) + 4))
#define S12PIM_CHANNEL_P_5                      ((Kdk_ChannelType)((4 * 8) + 5))
#define S12PIM_CHANNEL_P_6                      ((Kdk_ChannelType)((4 * 8) + 6))
#define S12PIM_CHANNEL_P_7                      ((Kdk_ChannelType)((4 * 8) + 7))

#define S12PIM_CHANNEL_H_0                      ((Kdk_ChannelType)((5 * 8) + 0))
#define S12PIM_CHANNEL_H_1                      ((Kdk_ChannelType)((5 * 8) + 1))
#define S12PIM_CHANNEL_H_2                      ((Kdk_ChannelType)((5 * 8) + 2))
#define S12PIM_CHANNEL_H_3                      ((Kdk_ChannelType)((5 * 8) + 3))
#define S12PIM_CHANNEL_H_4                      ((Kdk_ChannelType)((5 * 8) + 4))
#define S12PIM_CHANNEL_H_5                      ((Kdk_ChannelType)((5 * 8) + 5))
#define S12PIM_CHANNEL_H_6                      ((Kdk_ChannelType)((5 * 8) + 6))
#define S12PIM_CHANNEL_H_7                      ((Kdk_ChannelType)((5 * 8) + 7))

#define S12PIM2_CHANNEL_R_0                      ((Kdk_ChannelType)((6 * 8) + 0))
#define S12PIM2_CHANNEL_R_1                      ((Kdk_ChannelType)((6 * 8) + 1))
#define S12PIM2_CHANNEL_R_2                      ((Kdk_ChannelType)((6 * 8) + 2))
#define S12PIM2_CHANNEL_R_3                      ((Kdk_ChannelType)((6 * 8) + 3))
#define S12PIM2_CHANNEL_R_4                      ((Kdk_ChannelType)((6 * 8) + 4))
#define S12PIM2_CHANNEL_R_5                      ((Kdk_ChannelType)((6 * 8) + 5))
#define S12PIM2_CHANNEL_R_6                      ((Kdk_ChannelType)((6 * 8) + 6))
#define S12PIM2_CHANNEL_R_7                      ((Kdk_ChannelType)((6 * 8) + 7))

#define S12PIM_CHANNEL_U_0                      ((Kdk_ChannelType)((7 * 8) + 0))
#define S12PIM_CHANNEL_U_1                      ((Kdk_ChannelType)((7 * 8) + 1))
#define S12PIM_CHANNEL_U_2                      ((Kdk_ChannelType)((7 * 8) + 2))
#define S12PIM_CHANNEL_U_3                      ((Kdk_ChannelType)((7 * 8) + 3))
#define S12PIM_CHANNEL_U_4                      ((Kdk_ChannelType)((7 * 8) + 4))
#define S12PIM_CHANNEL_U_5                      ((Kdk_ChannelType)((7 * 8) + 5))
#define S12PIM_CHANNEL_U_6                      ((Kdk_ChannelType)((7 * 8) + 6))
#define S12PIM_CHANNEL_U_7                      ((Kdk_ChannelType)((7 * 8) + 7))

#define S12PIM_CHANNEL_V_0                      ((Kdk_ChannelType)((8 * 8) + 0))
#define S12PIM_CHANNEL_V_1                      ((Kdk_ChannelType)((8 * 8) + 1))
#define S12PIM_CHANNEL_V_2                      ((Kdk_ChannelType)((8 * 8) + 2))
#define S12PIM_CHANNEL_V_3                      ((Kdk_ChannelType)((8 * 8) + 3))
#define S12PIM_CHANNEL_V_4                      ((Kdk_ChannelType)((8 * 8) + 4))
#define S12PIM_CHANNEL_V_5                      ((Kdk_ChannelType)((8 * 8) + 5))
#define S12PIM_CHANNEL_V_6                      ((Kdk_ChannelType)((8 * 8) + 6))
#define S12PIM_CHANNEL_V_7                      ((Kdk_ChannelType)((8 * 8) + 7))
