 ...
 *
 */
#if !defined(__MC9S12UF32_CONFIG_H)
#define __MC9S12UF32_CONFIG_H
...
#define S12_FEATURE_ATA5HC      STD_ON
...
#define S12_FEATURE_CFHC        STD_ON
...
#define S12_FEATURE_DBG         STD_OFF
...
#define S12_FEATURE_IQUE        STD_ON
...
#define S12_FEATURE_MSHC        STD_ON
...
#define S12_FEATURE_SDHC        STD_ON
#define S12_FEATURE_SINT        STD_OFF
#define S12_FEATURE_SMHC        STD_ON
#define S12_FEATURE_SMRAM       STD_ON
#define S12_FEATURE_SPI0        STD_OFF
...
#define S12_FEATURE_USB20       STD_ON
...
#define BASE_ADDR_PLL           KDK_MAKE_BASE_ADDR(0x0035)
...
#define BASE_ADDR_SMRAM         KDK_MAKE_BASE_ADDR(0x011C)
#define BASE_ADDR_ATA5HC        KDK_MAKE_BASE_ADDR(0x01C0)
#define BASE_ADDR_IQUE          KDK_MAKE_BASE_ADDR(0x0200)
#define BASE_ADDR_T             KDK_MAKE_BASE_ADDR(0x0240)
#define BASE_ADDR_M             KDK_MAKE_BASE_ADDR(0x0248)
#define BASE_ADDR_J             KDK_MAKE_BASE_ADDR(0x0250)
#define BASE_ADDR_P             KDK_MAKE_BASE_ADDR(0x0258)
#define BASE_ADDR_Q             KDK_MAKE_BASE_ADDR(0x0260)
#define BASE_ADDR_R             KDK_MAKE_BASE_ADDR(0x0268)
#define BASE_ADDR_S             KDK_MAKE_BASE_ADDR(0x0270)
#define BASE_ADDR_U             KDK_MAKE_BASE_ADDR(0x0278)
#define BASE_ADDR_CFHC          KDK_MAKE_BASE_ADDR(0x0280)
#define BASE_ADDR_MSHC          KDK_MAKE_BASE_ADDR(0x02A0)
#define BASE_ADDR_SMHC          KDK_MAKE_BASE_ADDR(0x02B0)
#define BASE_ADDR_SDHC          KDK_MAKE_BASE_ADDR(0x02C0)
#define BASE_ADDR_USB20         KDK_MAKE_BASE_ADDR(0x0300)
...
#define S12_SPI_NUM_INTERFACES                  ((uint8)0)
...
#define S12PIM_PORT_M                           ((Kdk_PortType)0x1)  /* 0x248 */
#define S12PIM_PORT_J                           ((Kdk_PortType)0x2)  /* 0x250 */
#define S12PIM_PORT_P                           ((Kdk_PortType)0x3)  /* 0x258 */
#define S12PIM_PORT_Q                           ((Kdk_PortType)0x4)  /* 0x260 */
#define S12PIM2_PORT_R                           ((Kdk_PortType)0x5)  /* 0x268 */
#define S12PIM_PORT_S                           ((Kdk_PortType)0x6)  /* 0x270 */
#define S12PIM_PORT_U                           ((Kdk_PortType)0x7)  /* 0x278 */
...
#define S12PIM_CHANNEL_M_0                      ((Kdk_ChannelType)((1 * 8) + 0))
#define S12PIM_CHANNEL_M_1                      ((Kdk_ChannelType)((1 * 8) + 1))
#define S12PIM_CHANNEL_M_2                      ((Kdk_ChannelType)((1 * 8) + 2))
#define S12PIM_CHANNEL_M_3                      ((Kdk_ChannelType)((1 * 8) + 3))
#define S12PIM_CHANNEL_M_4                      ((Kdk_ChannelType)((1 * 8) + 4))
#define S12PIM_CHANNEL_M_5                      ((Kdk_ChannelType)((1 * 8) + 5))
#define S12PIM_CHANNEL_M_6                      ((Kdk_ChannelType)((1 * 8) + 6))
#define S12PIM_CHANNEL_M_7                      ((Kdk_ChannelType)((1 * 8) + 7))

#define S12PIM_CHANNEL_J_0                      ((Kdk_ChannelType)((2 * 8) + 0))
#define S12PIM_CHANNEL_J_1                      ((Kdk_ChannelType)((2 * 8) + 1))
#define S12PIM_CHANNEL_J_2                      ((Kdk_ChannelType)((2 * 8) + 2))
#define S12PIM_CHANNEL_J_3                      ((Kdk_ChannelType)((2 * 8) + 3))
#define S12PIM_CHANNEL_J_4                      ((Kdk_ChannelType)((2 * 8) + 4))
#define S12PIM_CHANNEL_J_5                      ((Kdk_ChannelType)((2 * 8) + 5))
#define S12PIM_CHANNEL_J_6                      ((Kdk_ChannelType)((2 * 8) + 6))
#define S12PIM_CHANNEL_J_7                      ((Kdk_ChannelType)((2 * 8) + 7))
...
#define S12PIM_CHANNEL_Q_0                      ((Kdk_ChannelType)((4 * 8) + 0))
#define S12PIM_CHANNEL_Q_1                      ((Kdk_ChannelType)((4 * 8) + 1))
#define S12PIM_CHANNEL_Q_2                      ((Kdk_ChannelType)((4 * 8) + 2))
#define S12PIM_CHANNEL_Q_3                      ((Kdk_ChannelType)((4 * 8) + 3))
#define S12PIM_CHANNEL_Q_4                      ((Kdk_ChannelType)((4 * 8) + 4))
#define S12PIM_CHANNEL_Q_5                      ((Kdk_ChannelType)((4 * 8) + 5))
#define S12PIM_CHANNEL_Q_6                      ((Kdk_ChannelType)((4 * 8) + 6))
#define S12PIM_CHANNEL_Q_7                      ((Kdk_ChannelType)((4 * 8) + 7))

#define S12PIM2_CHANNEL_R_0                      ((Kdk_ChannelType)((5 * 8) + 0))
#define S12PIM2_CHANNEL_R_1                      ((Kdk_ChannelType)((5 * 8) + 1))
#define S12PIM2_CHANNEL_R_2                      ((Kdk_ChannelType)((5 * 8) + 2))
#define S12PIM2_CHANNEL_R_3                      ((Kdk_ChannelType)((5 * 8) + 3))
#define S12PIM2_CHANNEL_R_4                      ((Kdk_ChannelType)((5 * 8) + 4))
#define S12PIM2_CHANNEL_R_5                      ((Kdk_ChannelType)((5 * 8) + 5))
#define S12PIM2_CHANNEL_R_6                      ((Kdk_ChannelType)((5 * 8) + 6))
#define S12PIM2_CHANNEL_R_7                      ((Kdk_ChannelType)((5 * 8) + 7))

#define S12PIM_CHANNEL_S_0                      ((Kdk_ChannelType)((6 * 8) + 0))
#define S12PIM_CHANNEL_S_1                      ((Kdk_ChannelType)((6 * 8) + 1))
#define S12PIM_CHANNEL_S_2                      ((Kdk_ChannelType)((6 * 8) + 2))
#define S12PIM_CHANNEL_S_3                      ((Kdk_ChannelType)((6 * 8) + 3))
#define S12PIM_CHANNEL_S_4                      ((Kdk_ChannelType)((6 * 8) + 4))
#define S12PIM_CHANNEL_S_5                      ((Kdk_ChannelType)((6 * 8) + 5))
#define S12PIM_CHANNEL_S_6                      ((Kdk_ChannelType)((6 * 8) + 6))
#define S12PIM_CHANNEL_S_7                      ((Kdk_ChannelType)((6 * 8) + 7))
