 ...
 *
 */
#if !defined(__MC9S12XHY256_CONFIG_H)
#define __MC9S12XHY256_CONFIG_H
...
#define S12_FEATURE_CRG         STD_OFF
...
#define S12_FEATURE_ECRG        STD_ON
...
#define S12_FEATURE_TIM0        STD_ON
#define S12_FEATURE_TIM1        STD_ON
...
#define BASE_ADDR_MMC           KDK_MAKE_BASE_ADDR(0x000B)
...
#define BASE_ADDR_ECRG          KDK_MAKE_BASE_ADDR(0x0034)
#define BASE_ADDR_RTI           KDK_MAKE_BASE_ADDR(0x003B)
#define BASE_ADDR_COP           KDK_MAKE_BASE_ADDR(0x003C)
#define BASE_ADDR_TIM0          KDK_MAKE_BASE_ADDR(0x0040)
#define BASE_ADDR_ADC0          KDK_MAKE_BASE_ADDR(0x0070)
#define BASE_ADDR_PWM8          KDK_MAKE_BASE_ADDR(0x00A0)
#define BASE_ADDR_PWM16         KDK_MAKE_BASE_ADDR(0x00AC)
...
#define BASE_ADDR_LCD           KDK_MAKE_BASE_ADDR(0x0200)
#define BASE_ADDR_SSD0          KDK_MAKE_BASE_ADDR(0x0220)
#define BASE_ADDR_SSD1          KDK_MAKE_BASE_ADDR(0x0228)
#define BASE_ADDR_SSD2          KDK_MAKE_BASE_ADDR(0x0230)
#define BASE_ADDR_SSD3          KDK_MAKE_BASE_ADDR(0x0238)
...
#define BASE_ADDR_R             KDK_MAKE_BASE_ADDR(0x0280)
#define BASE_ADDR_U             KDK_MAKE_BASE_ADDR(0x0290)
#define BASE_ADDR_V             KDK_MAKE_BASE_ADDR(0x0298)
#define BASE_ADDR_TIM1          KDK_MAKE_BASE_ADDR(0x02A0)
#define BASE_ADDR_VREG          KDK_MAKE_BASE_ADDR(0x02F0)
...
#define S12PIM_PORT_T                           ((Kdk_PortType)0x2)  /* 0x240 */
#define S12PIM_PORT_S                           ((Kdk_PortType)0x3)  /* 0x248 */
#define S12PIM_PORT_M                           ((Kdk_PortType)0x4)  /* 0x250 */
#define S12PIM_PORT_P                           ((Kdk_PortType)0x5)  /* 0x258 */
#define S12PIM_PORT_H                           ((Kdk_PortType)0x6)  /* 0x260 */
#define S12PIM2_PORT_R                           ((Kdk_PortType)0x7)  /* 0x280 */
#define S12PIM_PORT_U                           ((Kdk_PortType)0x8)  /* 0x290 */
#define S12PIM_PORT_V                           ((Kdk_PortType)0x9)  /* 0x298 */
...
#define S12PIM_CHANNEL_T_0                      ((Kdk_ChannelType)((2 * 8) + 0))
#define S12PIM_CHANNEL_T_1                      ((Kdk_ChannelType)((2 * 8) + 1))
#define S12PIM_CHANNEL_T_2                      ((Kdk_ChannelType)((2 * 8) + 2))
#define S12PIM_CHANNEL_T_3                      ((Kdk_ChannelType)((2 * 8) + 3))
#define S12PIM_CHANNEL_T_4                      ((Kdk_ChannelType)((2 * 8) + 4))
#define S12PIM_CHANNEL_T_5                      ((Kdk_ChannelType)((2 * 8) + 5))
#define S12PIM_CHANNEL_T_6                      ((Kdk_ChannelType)((2 * 8) + 6))
#define S12PIM_CHANNEL_T_7                      ((Kdk_ChannelType)((2 * 8) + 7))

#define S12PIM_CHANNEL_S_0                      ((Kdk_ChannelType)((3 * 8) + 0))
#define S12PIM_CHANNEL_S_1                      ((Kdk_ChannelType)((3 * 8) + 1))
#define S12PIM_CHANNEL_S_2                      ((Kdk_ChannelType)((3 * 8) + 2))
#define S12PIM_CHANNEL_S_3                      ((Kdk_ChannelType)((3 * 8) + 3))
#define S12PIM_CHANNEL_S_4                      ((Kdk_ChannelType)((3 * 8) + 4))
#define S12PIM_CHANNEL_S_5                      ((Kdk_ChannelType)((3 * 8) + 5))
#define S12PIM_CHANNEL_S_6                      ((Kdk_ChannelType)((3 * 8) + 6))
#define S12PIM_CHANNEL_S_7                      ((Kdk_ChannelType)((3 * 8) + 7))

#define S12PIM_CHANNEL_M_0                      ((Kdk_ChannelType)((4 * 8) + 0))
#define S12PIM_CHANNEL_M_1                      ((Kdk_ChannelType)((4 * 8) + 1))
#define S12PIM_CHANNEL_M_2                      ((Kdk_ChannelType)((4 * 8) + 2))
#define S12PIM_CHANNEL_M_3                      ((Kdk_ChannelType)((4 * 8) + 3))
#define S12PIM_CHANNEL_M_4                      ((Kdk_ChannelType)((4 * 8) + 4))
#define S12PIM_CHANNEL_M_5                      ((Kdk_ChannelType)((4 * 8) + 5))
#define S12PIM_CHANNEL_M_6                      ((Kdk_ChannelType)((4 * 8) + 6))
#define S12PIM_CHANNEL_M_7                      ((Kdk_ChannelType)((4 * 8) + 7))

#define S12PIM_CHANNEL_P_0                      ((Kdk_ChannelType)((5 * 8) + 0))
#define S12PIM_CHANNEL_P_1                      ((Kdk_ChannelType)((5 * 8) + 1))
#define S12PIM_CHANNEL_P_2                      ((Kdk_ChannelType)((5 * 8) + 2))
#define S12PIM_CHANNEL_P_3                      ((Kdk_ChannelType)((5 * 8) + 3))
#define S12PIM_CHANNEL_P_4                      ((Kdk_ChannelType)((5 * 8) + 4))
#define S12PIM_CHANNEL_P_5                      ((Kdk_ChannelType)((5 * 8) + 5))
#define S12PIM_CHANNEL_P_6                      ((Kdk_ChannelType)((5 * 8) + 6))
#define S12PIM_CHANNEL_P_7                      ((Kdk_ChannelType)((5 * 8) + 7))

#define S12PIM_CHANNEL_H_0                      ((Kdk_ChannelType)((6 * 8) + 0))
#define S12PIM_CHANNEL_H_1                      ((Kdk_ChannelType)((6 * 8) + 1))
#define S12PIM_CHANNEL_H_2                      ((Kdk_ChannelType)((6 * 8) + 2))
#define S12PIM_CHANNEL_H_3                      ((Kdk_ChannelType)((6 * 8) + 3))
#define S12PIM_CHANNEL_H_4                      ((Kdk_ChannelType)((6 * 8) + 4))
#define S12PIM_CHANNEL_H_5                      ((Kdk_ChannelType)((6 * 8) + 5))
#define S12PIM_CHANNEL_H_6                      ((Kdk_ChannelType)((6 * 8) + 6))
#define S12PIM_CHANNEL_H_7                      ((Kdk_ChannelType)((6 * 8) + 7))

#define S12PIM2_CHANNEL_R_0                      ((Kdk_ChannelType)((7 * 8) + 0))
#define S12PIM2_CHANNEL_R_1                      ((Kdk_ChannelType)((7 * 8) + 1))
#define S12PIM2_CHANNEL_R_2                      ((Kdk_ChannelType)((7 * 8) + 2))
#define S12PIM2_CHANNEL_R_3                      ((Kdk_ChannelType)((7 * 8) + 3))
#define S12PIM2_CHANNEL_R_4                      ((Kdk_ChannelType)((7 * 8) + 4))
#define S12PIM2_CHANNEL_R_5                      ((Kdk_ChannelType)((7 * 8) + 5))
#define S12PIM2_CHANNEL_R_6                      ((Kdk_ChannelType)((7 * 8) + 6))
#define S12PIM2_CHANNEL_R_7                      ((Kdk_ChannelType)((7 * 8) + 7))

#define S12PIM_CHANNEL_U_0                      ((Kdk_ChannelType)((8 * 8) + 0))
#define S12PIM_CHANNEL_U_1                      ((Kdk_ChannelType)((8 * 8) + 1))
#define S12PIM_CHANNEL_U_2                      ((Kdk_ChannelType)((8 * 8) + 2))
#define S12PIM_CHANNEL_U_3                      ((Kdk_ChannelType)((8 * 8) + 3))
#define S12PIM_CHANNEL_U_4                      ((Kdk_ChannelType)((8 * 8) + 4))
#define S12PIM_CHANNEL_U_5                      ((Kdk_ChannelType)((8 * 8) + 5))
#define S12PIM_CHANNEL_U_6                      ((Kdk_ChannelType)((8 * 8) + 6))
#define S12PIM_CHANNEL_U_7                      ((Kdk_ChannelType)((8 * 8) + 7))

#define S12PIM_CHANNEL_V_0                      ((Kdk_ChannelType)((9 * 8) + 0))
#define S12PIM_CHANNEL_V_1                      ((Kdk_ChannelType)((9 * 8) + 1))
#define S12PIM_CHANNEL_V_2                      ((Kdk_ChannelType)((9 * 8) + 2))
#define S12PIM_CHANNEL_V_3                      ((Kdk_ChannelType)((9 * 8) + 3))
#define S12PIM_CHANNEL_V_4                      ((Kdk_ChannelType)((9 * 8) + 4))
#define S12PIM_CHANNEL_V_5                      ((Kdk_ChannelType)((9 * 8) + 5))
#define S12PIM_CHANNEL_V_6                      ((Kdk_ChannelType)((9 * 8) + 6))
#define S12PIM_CHANNEL_V_7                      ((Kdk_ChannelType)((9 * 8) + 7))
...
#define S12_FLS_HAS_ECC_FLASH       STD_ON
