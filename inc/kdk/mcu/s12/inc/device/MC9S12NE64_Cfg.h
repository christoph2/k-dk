 ...
 *
 */
#if !defined(__MC9S12NE64_CONFIG_H)
#define __MC9S12NE64_CONFIG_H
...
#define S12_FEATURE_EMAC        STD_ON
#define S12_FEATURE_EPHY        STD_ON
...
#define BASE_ADDR_EPHY          KDK_MAKE_BASE_ADDR(0x0120)
#define BASE_ADDR_EMAC          KDK_MAKE_BASE_ADDR(0x0140)
#define BASE_ADDR_T             KDK_MAKE_BASE_ADDR(0x0240)
#define BASE_ADDR_S             KDK_MAKE_BASE_ADDR(0x0248)
#define BASE_ADDR_G             KDK_MAKE_BASE_ADDR(0x0250)
#define BASE_ADDR_H             KDK_MAKE_BASE_ADDR(0x0258)
#define BASE_ADDR_J             KDK_MAKE_BASE_ADDR(0x0260)
#define BASE_ADDR_L             KDK_MAKE_BASE_ADDR(0x0268)
...
#define S12PIM_PORT_G                           ((Kdk_PortType)0x2)  /* 0x250 */
#define S12PIM_PORT_H                           ((Kdk_PortType)0x3)  /* 0x258 */
#define S12PIM_PORT_J                           ((Kdk_PortType)0x4)  /* 0x260 */
#define S12PIM2_PORT_L                           ((Kdk_PortType)0x5)  /* 0x268 */
...
#define S12PIM_CHANNEL_G_0                      ((Kdk_ChannelType)((2 * 8) + 0))
#define S12PIM_CHANNEL_G_1                      ((Kdk_ChannelType)((2 * 8) + 1))
#define S12PIM_CHANNEL_G_2                      ((Kdk_ChannelType)((2 * 8) + 2))
#define S12PIM_CHANNEL_G_3                      ((Kdk_ChannelType)((2 * 8) + 3))
#define S12PIM_CHANNEL_G_4                      ((Kdk_ChannelType)((2 * 8) + 4))
#define S12PIM_CHANNEL_G_5                      ((Kdk_ChannelType)((2 * 8) + 5))
#define S12PIM_CHANNEL_G_6                      ((Kdk_ChannelType)((2 * 8) + 6))
#define S12PIM_CHANNEL_G_7                      ((Kdk_ChannelType)((2 * 8) + 7))

#define S12PIM_CHANNEL_H_0                      ((Kdk_ChannelType)((3 * 8) + 0))
#define S12PIM_CHANNEL_H_1                      ((Kdk_ChannelType)((3 * 8) + 1))
#define S12PIM_CHANNEL_H_2                      ((Kdk_ChannelType)((3 * 8) + 2))
#define S12PIM_CHANNEL_H_3                      ((Kdk_ChannelType)((3 * 8) + 3))
#define S12PIM_CHANNEL_H_4                      ((Kdk_ChannelType)((3 * 8) + 4))
#define S12PIM_CHANNEL_H_5                      ((Kdk_ChannelType)((3 * 8) + 5))
#define S12PIM_CHANNEL_H_6                      ((Kdk_ChannelType)((3 * 8) + 6))
#define S12PIM_CHANNEL_H_7                      ((Kdk_ChannelType)((3 * 8) + 7))
...
#define S12PIM2_CHANNEL_L_0                      ((Kdk_ChannelType)((5 * 8) + 0))
#define S12PIM2_CHANNEL_L_1                      ((Kdk_ChannelType)((5 * 8) + 1))
#define S12PIM2_CHANNEL_L_2                      ((Kdk_ChannelType)((5 * 8) + 2))
#define S12PIM2_CHANNEL_L_3                      ((Kdk_ChannelType)((5 * 8) + 3))
#define S12PIM2_CHANNEL_L_4                      ((Kdk_ChannelType)((5 * 8) + 4))
#define S12PIM2_CHANNEL_L_5                      ((Kdk_ChannelType)((5 * 8) + 5))
#define S12PIM2_CHANNEL_L_6                      ((Kdk_ChannelType)((5 * 8) + 6))
#define S12PIM2_CHANNEL_L_7                      ((Kdk_ChannelType)((5 * 8) + 7))
