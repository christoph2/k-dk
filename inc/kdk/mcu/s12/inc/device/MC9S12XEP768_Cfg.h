 ...
 *
 */
#if !defined(__MC9S12XEP768_CONFIG_H)
#define __MC9S12XEP768_CONFIG_H
...
#define S12_FEATURE_MPU         STD_ON
#define S12_FEATURE_MSCAN0      STD_ON
#define S12_FEATURE_MSCAN1      STD_ON
#define S12_FEATURE_MSCAN2      STD_ON
#define S12_FEATURE_MSCAN3      STD_ON
...
#define S12_FEATURE_SCI3        STD_ON
#define S12_FEATURE_SCI4        STD_ON
#define S12_FEATURE_SCI5        STD_ON
#define S12_FEATURE_SCI6        STD_ON
#define S12_FEATURE_SCI7        STD_ON
...
#define BASE_ADDR_IIC1          KDK_MAKE_BASE_ADDR(0x00B0)
#define BASE_ADDR_SCI2          KDK_MAKE_BASE_ADDR(0x00B8)
#define BASE_ADDR_SCI3          KDK_MAKE_BASE_ADDR(0x00C0)
...
#define BASE_ADDR_MPU           KDK_MAKE_BASE_ADDR(0x0114)
#define BASE_ADDR_INT           KDK_MAKE_BASE_ADDR(0x0121)
#define BASE_ADDR_SCI4          KDK_MAKE_BASE_ADDR(0x0130)
#define BASE_ADDR_SCI5          KDK_MAKE_BASE_ADDR(0x0138)
#define BASE_ADDR_MSCAN0        KDK_MAKE_BASE_ADDR(0x0140)
#define BASE_ADDR_MSCAN1        KDK_MAKE_BASE_ADDR(0x0180)
#define BASE_ADDR_MSCAN2        KDK_MAKE_BASE_ADDR(0x01C0)
#define BASE_ADDR_MSCAN3        KDK_MAKE_BASE_ADDR(0x0200)
...
#define BASE_ADDR_SCI6          KDK_MAKE_BASE_ADDR(0x0330)
#define BASE_ADDR_SCI7          KDK_MAKE_BASE_ADDR(0x0338)
#define BASE_ADDR_PIT           KDK_MAKE_BASE_ADDR(0x0340)
#define BASE_ADDR_R             KDK_MAKE_BASE_ADDR(0x0368)
#define BASE_ADDR_L             KDK_MAKE_BASE_ADDR(0x0370)
#define BASE_ADDR_F             KDK_MAKE_BASE_ADDR(0x0378)
#define BASE_ADDR_XGATE         KDK_MAKE_BASE_ADDR(0x0380)
#define BASE_ADDR_TIM           KDK_MAKE_BASE_ADDR(0x03D0)


#define S12_CAN_NUM_CONTROLLERS                 ((uint8)5)
...
#define S12_SCI_NUM_INTERFACES                  ((uint8)8)
...
#define S12PIM2_PORT_R                           ((Kdk_PortType)0xc)  /* 0x368 */
#define S12PIM2_PORT_L                           ((Kdk_PortType)0xd)  /* 0x370 */
#define S12PIM2_PORT_F                           ((Kdk_PortType)0xe)  /* 0x378 */
...
#define S12PIM2_CHANNEL_R_0                      ((Kdk_ChannelType)((12 * 8) + 0))
#define S12PIM2_CHANNEL_R_1                      ((Kdk_ChannelType)((12 * 8) + 1))
#define S12PIM2_CHANNEL_R_2                      ((Kdk_ChannelType)((12 * 8) + 2))
#define S12PIM2_CHANNEL_R_3                      ((Kdk_ChannelType)((12 * 8) + 3))
#define S12PIM2_CHANNEL_R_4                      ((Kdk_ChannelType)((12 * 8) + 4))
#define S12PIM2_CHANNEL_R_5                      ((Kdk_ChannelType)((12 * 8) + 5))
#define S12PIM2_CHANNEL_R_6                      ((Kdk_ChannelType)((12 * 8) + 6))
#define S12PIM2_CHANNEL_R_7                      ((Kdk_ChannelType)((12 * 8) + 7))

#define S12PIM2_CHANNEL_L_0                      ((Kdk_ChannelType)((13 * 8) + 0))
#define S12PIM2_CHANNEL_L_1                      ((Kdk_ChannelType)((13 * 8) + 1))
#define S12PIM2_CHANNEL_L_2                      ((Kdk_ChannelType)((13 * 8) + 2))
#define S12PIM2_CHANNEL_L_3                      ((Kdk_ChannelType)((13 * 8) + 3))
#define S12PIM2_CHANNEL_L_4                      ((Kdk_ChannelType)((13 * 8) + 4))
#define S12PIM2_CHANNEL_L_5                      ((Kdk_ChannelType)((13 * 8) + 5))
#define S12PIM2_CHANNEL_L_6                      ((Kdk_ChannelType)((13 * 8) + 6))
#define S12PIM2_CHANNEL_L_7                      ((Kdk_ChannelType)((13 * 8) + 7))

#define S12PIM2_CHANNEL_F_0                      ((Kdk_ChannelType)((14 * 8) + 0))
#define S12PIM2_CHANNEL_F_1                      ((Kdk_ChannelType)((14 * 8) + 1))
#define S12PIM2_CHANNEL_F_2                      ((Kdk_ChannelType)((14 * 8) + 2))
#define S12PIM2_CHANNEL_F_3                      ((Kdk_ChannelType)((14 * 8) + 3))
#define S12PIM2_CHANNEL_F_4                      ((Kdk_ChannelType)((14 * 8) + 4))
#define S12PIM2_CHANNEL_F_5                      ((Kdk_ChannelType)((14 * 8) + 5))
#define S12PIM2_CHANNEL_F_6                      ((Kdk_ChannelType)((14 * 8) + 6))
#define S12PIM2_CHANNEL_F_7                      ((Kdk_ChannelType)((14 * 8) + 7))
