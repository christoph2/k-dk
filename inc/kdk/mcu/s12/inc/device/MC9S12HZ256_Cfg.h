 ...
 *
 */
#if !defined(__MC9S12HZ256_CONFIG_H)
#define __MC9S12HZ256_CONFIG_H
...
#define BASE_ADDR_BKP           KDK_MAKE_BASE_ADDR(0x0020)
...
#define BASE_ADDR_ATD           KDK_MAKE_BASE_ADDR(0x0080)
...
#define BASE_ADDR_NV            KDK_MAKE_BASE_ADDR(0xFF00)
...
#define S12PIM2_PORT_L                           ((Kdk_PortType)0x4)  /* 0x230 */
#define S12PIM_PORT_U                           ((Kdk_PortType)0x5)  /* 0x238 */
#define S12PIM_PORT_V                           ((Kdk_PortType)0x6)  /* 0x240 */
...
#define S12PIM2_CHANNEL_L_0                      ((Kdk_ChannelType)((4 * 8) + 0))
#define S12PIM2_CHANNEL_L_1                      ((Kdk_ChannelType)((4 * 8) + 1))
#define S12PIM2_CHANNEL_L_2                      ((Kdk_ChannelType)((4 * 8) + 2))
#define S12PIM2_CHANNEL_L_3                      ((Kdk_ChannelType)((4 * 8) + 3))
#define S12PIM2_CHANNEL_L_4                      ((Kdk_ChannelType)((4 * 8) + 4))
#define S12PIM2_CHANNEL_L_5                      ((Kdk_ChannelType)((4 * 8) + 5))
#define S12PIM2_CHANNEL_L_6                      ((Kdk_ChannelType)((4 * 8) + 6))
#define S12PIM2_CHANNEL_L_7                      ((Kdk_ChannelType)((4 * 8) + 7))

#define S12PIM_CHANNEL_U_0                      ((Kdk_ChannelType)((5 * 8) + 0))
#define S12PIM_CHANNEL_U_1                      ((Kdk_ChannelType)((5 * 8) + 1))
#define S12PIM_CHANNEL_U_2                      ((Kdk_ChannelType)((5 * 8) + 2))
#define S12PIM_CHANNEL_U_3                      ((Kdk_ChannelType)((5 * 8) + 3))
#define S12PIM_CHANNEL_U_4                      ((Kdk_ChannelType)((5 * 8) + 4))
#define S12PIM_CHANNEL_U_5                      ((Kdk_ChannelType)((5 * 8) + 5))
#define S12PIM_CHANNEL_U_6                      ((Kdk_ChannelType)((5 * 8) + 6))
#define S12PIM_CHANNEL_U_7                      ((Kdk_ChannelType)((5 * 8) + 7))

#define S12PIM_CHANNEL_V_0                      ((Kdk_ChannelType)((6 * 8) + 0))
#define S12PIM_CHANNEL_V_1                      ((Kdk_ChannelType)((6 * 8) + 1))
#define S12PIM_CHANNEL_V_2                      ((Kdk_ChannelType)((6 * 8) + 2))
#define S12PIM_CHANNEL_V_3                      ((Kdk_ChannelType)((6 * 8) + 3))
#define S12PIM_CHANNEL_V_4                      ((Kdk_ChannelType)((6 * 8) + 4))
#define S12PIM_CHANNEL_V_5                      ((Kdk_ChannelType)((6 * 8) + 5))
#define S12PIM_CHANNEL_V_6                      ((Kdk_ChannelType)((6 * 8) + 6))
#define S12PIM_CHANNEL_V_7                      ((Kdk_ChannelType)((6 * 8) + 7))
