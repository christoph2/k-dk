 ...
 *
 */
#if !defined(__MC9S12XF512_CONFIG_H)
#define __MC9S12XF512_CONFIG_H
...
#define S12_FEATURE_CGMIPLL     STD_ON
...
#define S12_FEATURE_EPIT        STD_ON
#define S12_FEATURE_F           STD_OFF
#define S12_FEATURE_FLASH       STD_OFF
#define S12_FEATURE_FLEXRAY     STD_ON
...
#define BASE_ADDR_CGMIPLL       KDK_MAKE_BASE_ADDR(0x0300)
#define BASE_ADDR_EPIT          KDK_MAKE_BASE_ADDR(0x0340)
#define BASE_ADDR_XGATE         KDK_MAKE_BASE_ADDR(0x0380)
#define BASE_ADDR_FLEXRAY       KDK_MAKE_BASE_ADDR(0x0400)
