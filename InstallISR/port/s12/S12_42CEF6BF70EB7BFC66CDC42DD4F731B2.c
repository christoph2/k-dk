...
#if !defined(SSD5_VECTOR)
#define SSD5_VECTOR             DUMMY_VECTOR
#endif  /* SSD5_VECTOR          */
...
#if !defined(SSD4_VECTOR)
#define SSD4_VECTOR             DUMMY_VECTOR
#endif  /* SSD4_VECTOR          */
...
#endif
    (IISR_IVF)SI_VECTOR,           
    (IISR_IVF)DUMMY_VECTOR,             /* Reserved - 0xff12 */
