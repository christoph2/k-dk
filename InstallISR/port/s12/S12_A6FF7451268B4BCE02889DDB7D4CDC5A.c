...
#if !defined(INTRIG_VECTOR)
#define INTRIG_VECTOR           DUMMY_VECTOR
#endif  /* INTRIG_VECTOR        */

#if !defined(PIT7_VECTOR)
#define PIT7_VECTOR             DUMMY_VECTOR
#endif  /* PIT7_VECTOR          */

#if !defined(PIT6_VECTOR)
#define PIT6_VECTOR             DUMMY_VECTOR
#endif  /* PIT6_VECTOR          */

#if !defined(PIT5_VECTOR)
#define PIT5_VECTOR             DUMMY_VECTOR
#endif  /* PIT5_VECTOR          */

#if !defined(PIT4_VECTOR)
#define PIT4_VECTOR             DUMMY_VECTOR
#endif  /* PIT4_VECTOR          */
...
#if !defined(CRGIPLLCOL_VECTOR)
#define CRGIPLLCOL_VECTOR       DUMMY_VECTOR
#endif  /* CRGIPLLCOL_VECTOR    */
...
void ( * const interrupt_vectors[])(void) = {
    ...
    (IISR_IVF)DUMMY_VECTOR,             /* Reserved - 0xff3e */
    ...
    (IISR_IVF)INTRIG_VECTOR,       
    (IISR_IVF)PIT7_VECTOR,         
    (IISR_IVF)PIT6_VECTOR,         
    (IISR_IVF)PIT5_VECTOR,         
    (IISR_IVF)PIT4_VECTOR,         
