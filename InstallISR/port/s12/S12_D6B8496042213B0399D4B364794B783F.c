...
#if !defined(BFGEN_VECTOR)
#define BFGEN_VECTOR            DUMMY_VECTOR
#endif  /* BFGEN_VECTOR         */

#if !defined(BFSYNC_VECTOR)
#define BFSYNC_VECTOR           DUMMY_VECTOR
#endif  /* BFSYNC_VECTOR        */

#if !defined(BFRX_VECTOR)
#define BFRX_VECTOR             DUMMY_VECTOR
#endif  /* BFRX_VECTOR          */

#if !defined(BFRXFIFO_VECTOR)
#define BFRXFIFO_VECTOR         DUMMY_VECTOR
#endif  /* BFRXFIFO_VECTOR      */
...
#if !defined(XIRQBFPSP_VECTOR)
#define XIRQBFPSP_VECTOR        DUMMY_VECTOR
#endif  /* XIRQBFPSP_VECTOR     */
...
__root void(* const interrupt_vectors[]) (void) = {
    ...
    (IISR_IVF)BFGEN_VECTOR,        
    (IISR_IVF)BFSYNC_VECTOR,       
    (IISR_IVF)BFRX_VECTOR,         
    (IISR_IVF)BFRXFIFO_VECTOR,     
