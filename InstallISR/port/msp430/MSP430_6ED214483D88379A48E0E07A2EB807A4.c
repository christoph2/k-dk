...
#if !defined(AES256_VECTOR)
#define AES256_VECTOR           DUMMY_VECTOR
#endif  /* AES256_VECTOR        */
...
#if !defined(COMP_E_VECTOR)
#define COMP_E_VECTOR           DUMMY_VECTOR
#endif  /* COMP_E_VECTOR        */
...
#pragma constseg = INTVEC   /* @ 0xff54 */
#pragma required = interrupt_vectors
#pragma location = 0xff90  /* Lowest Offset: 60 */
__root void(* const interrupt_vectors[]) (void) = {
    ...
    (IISR_IVF)TIMER1_A1_VECTOR,         /* Timer1_A3 CC1-2, TA                  */
    ...
    (IISR_IVF)COMP_E_VECTOR,            /* Comparator E                         */
