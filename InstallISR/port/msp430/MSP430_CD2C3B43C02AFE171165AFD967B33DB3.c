...
#if !defined(AES_VECTOR)
#define AES_VECTOR              DUMMY_VECTOR
#endif  /* AES_VECTOR           */
...
#if !defined(LCD_C_VECTOR)
#define LCD_C_VECTOR            DUMMY_VECTOR
#endif  /* LCD_C_VECTOR         */

#if !defined(TIMER3_A1_VECTOR)
#define TIMER3_A1_VECTOR        DUMMY_VECTOR
#endif  /* TIMER3_A1_VECTOR     */

#if !defined(TIMER3_A0_VECTOR)
#define TIMER3_A0_VECTOR        DUMMY_VECTOR
#endif  /* TIMER3_A0_VECTOR     */
...
#define USCI_A3_VECTOR          DUMMY_VECTOR
#endif  /* USCI_A3_VECTOR       */
...
#if !defined(AUX_VECTOR)
#define AUX_VECTOR              DUMMY_VECTOR
#endif  /* AUX_VECTOR           */
...
#if !defined(SD24B_VECTOR)
#define SD24B_VECTOR            DUMMY_VECTOR
#endif  /* SD24B_VECTOR         */
...
#pragma constseg = INTVEC   /* @ 0xff38 */
#pragma required = interrupt_vectors
#pragma location = 0xff80  /* Lowest Offset: 72 */
__root void(* const interrupt_vectors[]) (void) = {
    ...
    (IISR_IVF)AES_VECTOR,               /* AES                                  */
    (IISR_IVF)COMP_B_VECTOR,            /* Comparator B                         */
    (IISR_IVF)RTC_VECTOR,               /* RTC                                  */
    (IISR_IVF)LCD_C_VECTOR,             /* LCD C                                */
    (IISR_IVF)TIMER3_A1_VECTOR,         /* Timer3_A2 CC1, TA                    */
    (IISR_IVF)TIMER3_A0_VECTOR,         /* Timer3_A2 CC0                        */
    (IISR_IVF)PORT2_VECTOR,             /* Port 2                               */
    (IISR_IVF)TIMER2_A1_VECTOR,         /* Timer2_A2 CC1, TA                    */
    (IISR_IVF)TIMER2_A0_VECTOR,         /* Timer2_A2 CC0                        */
    (IISR_IVF)PORT1_VECTOR,             /* Port 1                               */
    (IISR_IVF)USCI_B1_VECTOR,           /* USCI B1 Receive/Transmit             */
    (IISR_IVF)USCI_A3_VECTOR,           /* USCI A3 Receive/Transmit             */
    (IISR_IVF)TIMER1_A1_VECTOR,         /* Timer1_A2 CC1, TA1                   */
    (IISR_IVF)TIMER1_A0_VECTOR,         /* Timer1_A2 CC0                        */
    (IISR_IVF)DMA_VECTOR,               /* DMA                                  */
    (IISR_IVF)AUX_VECTOR,               /* AUX Supply                           */
    (IISR_IVF)USCI_A2_VECTOR,           /* USCI A2 Receive/Transmit             */
    (IISR_IVF)USCI_A1_VECTOR,           /* USCI A1 Receive/Transmit             */
    (IISR_IVF)TIMER0_A1_VECTOR,         /* Timer0_A2 CC1-CC2, TA                */
    (IISR_IVF)TIMER0_A0_VECTOR,         /* Timer0_A2 CC0                        */
    (IISR_IVF)SD24B_VECTOR,             /* SD24B ADC                            */
