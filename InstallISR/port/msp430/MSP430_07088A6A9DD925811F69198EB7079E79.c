...
#if !defined(LCD_B_VECTOR)
#define LCD_B_VECTOR            DUMMY_VECTOR
#endif  /* LCD_B_VECTOR         */
...
#if !defined(LDO_PWR_VECTOR)
#define LDO_PWR_VECTOR          DUMMY_VECTOR
#endif  /* LDO_PWR_VECTOR       */
...
__root void(* const interrupt_vectors[]) (void) = {
    ...
    (IISR_IVF)LDO_PWR_VECTOR,           /* LDO Power Management event           */
