...
#if !defined(USCI_B3_VECTOR)
#define USCI_B3_VECTOR          DUMMY_VECTOR
#endif  /* USCI_B3_VECTOR       */
...
#pragma constseg = INTVEC   /* @ 0xff2e */
#pragma required = interrupt_vectors
#pragma location = 0xff80  /* Lowest Offset: 82 */
__root void(* const interrupt_vectors[]) (void) = {
    ...
    (IISR_IVF)USCI_B3_VECTOR,           /* USCI B3 Receive/Transmit             */
