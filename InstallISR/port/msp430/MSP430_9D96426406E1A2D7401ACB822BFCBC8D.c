...
__root void(* const interrupt_vectors[]) (void) = {
    ...
    (IISR_IVF)TIMER0_A1_VECTOR,         /* Timer0 A CC1-2, TA                   */
    (IISR_IVF)TIMER0_A0_VECTOR,         /* Timer0 A CC0                         */
    (IISR_IVF)WDT_VECTOR,               /* Watchdog Timer                       */
    (IISR_IVF)COMPARATORA_VECTOR,       /* Comparator A                         */
    (IISR_IVF)TIMER1_A1_VECTOR,         /* Timer1 A CC1-2, TA                   */
    (IISR_IVF)TIMER1_A0_VECTOR,         /* Timer1 A CC0                         */
